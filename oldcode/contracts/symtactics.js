...
let weatherGlitch = new Weather('Weather Glitch', 'All players may travel twice in a row.', { moves: 2 }),
  heavyRain = new Weather('Heavy Rain', 'All players must travel at 1/2 of their normal speed.', { speedFactor: 0.5 }),
  ...
  pollutedWind = new Weather('Polluted Wind', 'All players must pay 2 resources if they wish to travel this round.', {
    resources: 2,
  })
...
;(SYMTACTICS.sites.oysterFarm = oysterFarm), (SYMTACTICS.sites.trashVortex = trashVortex)
