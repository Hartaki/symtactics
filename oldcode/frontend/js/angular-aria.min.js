            ...
            return {
              post: function (f, e, g, c) {
                ...
                !g.hasOwnProperty('ngRequired') &&
                  ...
                  b('aria-required', 'ariaRequired', e, !1) &&
                  g.$observe('required', function () {
                    e.attr('aria-required', !!g.required)
                  })
                b('aria-invalid', 'ariaInvalid', e, !0) &&
                  f.$watch(
                    function () {
                      return c.$invalid
                    },
        ...
        return {
          ...
          compile: function (l, m) {
            ...
            return function (b, d, f) {
              if (
                !h(d, c) &&
                (a.config('bindRoleForClick') && !d.attr('role') && d.attr('role', 'button'),
                a.config('tabindex') && !d.attr('tabindex') && d.attr('tabindex', 0),
                a.config('bindKeydown') && !f.ngKeydown && !f.ngKeypress && !f.ngKeyup)
              )
